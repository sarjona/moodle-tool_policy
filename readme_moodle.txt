...
2. Copy 'js/jquery-eu-cookie-law-popup.js' into 'amd/src/jquery-eu-cookie-law-popup.js':
   ...
   2.a. Disable eslint checking
------------------
/* eslint-disable */
------------------

   2.b. Replace jquery reference
------------------
(function($) {
------------------
...
------------------
   ...
   2.c. Remove initialisation code. It will be added and configured only in the pages where is needed
------------------
...
4. Execute grunt to compile js and css
   grunt js
   grunt css
